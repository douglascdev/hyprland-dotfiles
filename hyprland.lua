...
-- Region screenshot with grim/slurp, copied to clipboard
hl.bind(mainMod .. " + RETURN", hl.dsp.exec_cmd('grim -g "$(slurp -w 0)" - | wl-copy'), { locked = true })
...
hl.bind(mainMod .. " + Up",     hl.dsp.exec_cmd("wpctl set-volume -l 1 @DEFAULT_AUDIO_SINK@ 5%+"), { repeating = true })
